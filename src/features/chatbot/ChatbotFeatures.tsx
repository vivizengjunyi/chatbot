            ...
            <div className="mt-4">
                <ul className="space-y-4">
                    {features.map((feature, index) => (
                        <li
                            key={index}
                            className="flex items-center p-4 bg-slate-50 rounded-lg shadow hover:scale-105 transform transition duration-200"
                        >
                            <div className="flex items-center justify-center flex-shrink-0 h-10 w-10 rounded-full bg-[#375F1B] text-white">
